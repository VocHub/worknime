...
var Spinnies = _interopDefault(require('spinnies'));
...
async function get(url, i) {
    ...
    try {
        ...
        let cookie = cookieString(setCookieParser.parse(resp.headers["set-cookie"]));
...
async function extract(url) {
    ...
    const $ = cheerio__default.load(response.data);
